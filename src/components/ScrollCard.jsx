...
function ScrollCard({id,rank,source,title,tagline,duration,onBookmarks}){
    const rankStyle = {
            ...
            <section className="flex flex-row border-b gap-3 border-edge">
                ...
                <div className="flex flex-col gap-2 w-full">
                    <div className="flex flex-row gap-3 items-center justify-between">
                        ...
                        <button onClick={()=>onBookmarks(id)}
                        className="cursor-pointer px-4 py-1 border border-edge bg-accent-soft/20 text-ink-soft hover:bg-accent/50 hover:text-white">Add Scrolls</button>
                    </div>
